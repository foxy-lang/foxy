...
namespace Foxy.CodeAnalysis
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        public void ReportRequiredTypeNotFound(string? foxyName, string metadataName)
        {
            var message = foxyName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{foxyName}' ('{metadataName}') cannot be resolved among the given references.";
            ReportError(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string? foxyName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = foxyName == null
                ...
                : $"The required type '{foxyName}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
            ReportError(default, message);
        }
