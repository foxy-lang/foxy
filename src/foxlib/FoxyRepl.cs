...
using Foxy.CodeAnalysis;
using Foxy.CodeAnalysis.Authoring;
...
namespace Foxy
{
    internal sealed class FoxyRepl : Repl
    {
        ...
        private static string GetSubmissionsDirectory()
        {
            ...
            var submissionsDirectory = Path.Combine(localAppData, "Foxy", "Submissions");
